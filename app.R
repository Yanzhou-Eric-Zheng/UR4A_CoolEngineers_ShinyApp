...
server <- function(input,output){
    ...
    setwd("C:/Users/Eric/SkyDrive/Documents/R/UR4A/Shiny")
    
    ### Data for Product A
    a <- as.numeric(read.table(file = "A.csv", sep=",", header=F))
    ...
    ### Data for Product B
    b <- as.numeric(read.table(file = "B.csv", sep=",", header=F))
    ...
    ### Data for Product C
    c <- as.numeric(read.table(file = "C.csv", sep=",", header=F))
    ...
    ### Data for Product D
    d <- as.numeric(read.table(file = "D.csv", sep=",", header=F))
    ...
    ### Data for Product E
    e <- as.numeric(read.table(file = "E.csv", sep=",", header=F))
